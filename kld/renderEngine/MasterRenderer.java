...
public class MasterRenderer {
    ...
    private NormalMappingRenderer norrmalMapRenderer;
    ...
    public MasterRenderer(Loader loader) {
        ...
        norrmalMapRenderer = new NormalMappingRenderer(projectionMatrix);
    }
    ...
    public void render(List<Light> lights, Camera camera, Vector4f clipPlane) {
        ...
        shader.stop();
        norrmalMapRenderer.render(normalMapEntities, clipPlane, lights, camera);
        terrainShader.start();
